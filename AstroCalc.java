...
public class AstroCalc {
    ...
    public static void getSunPosition2(double Lan, double Lon, Calendar date){
        ...
        */
        ...
        // 3. Вычисление эклиптических координат Солнца
        //эпоха 1980
        double Eg = 278.833540; //Эклиптическая долгота солнца на эпоху 1980 0.0 в градусах;
        //если бы оно двигалось по круговой орбите
        double OmegaG = 282.596403; // долгота Солнца в перигее в градусах
